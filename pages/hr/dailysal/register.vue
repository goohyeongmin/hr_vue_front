...
const dailyLaborSalaryList = ref<DailyLaborSalary[]>([]);
...
const registerbtn = async () => {
  ...
  selectedRows.value.forEach((element: DailyLaborSalary) => {
    const slaryData: SalaryData = {
